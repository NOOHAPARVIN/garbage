...
if (strlen($_SESSION['vamssid']==0)) {
  header('location:logout.php');
  } else{
    if(isset($_POST['submit']))
  {
    $did=$_SESSION['vamssid'];
    $name=$_POST['name'];
  $mobno=$_POST['mobilenumber'];
  $email=$_POST['email'];
  $address=$_POST['address'];
  $sql="update tblstaff set Name=:name,MobileNumber=:mobilenumber,Email=:email,Address=:address where ID=:did";
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form id="" method="post" novalidate>
                                    <?php
$did=$_SESSION['vamssid'];
$sql="SELECT * from  tblstaff where ID=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                                    <div class="form-group">
                                        <label>Your ID</label>
                                        <input type="text" class="form-control" id="exampleTextInput1" name="" value="<?php  echo $row->StaffID;?>" readonly='true'>
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
