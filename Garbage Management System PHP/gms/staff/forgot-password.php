...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblstaff WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblstaff set Password=:newpassword where Email=:email and MobileNumber=:mobile";
