...
<html lang="en">
<head>
<title>Garbage Management System: Update Staff</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Update Staff</a>
...
{               ?>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="driid" value="<?php  echo htmlentities($row->StaffID);?>" readonly='true' maxlength="10">
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
