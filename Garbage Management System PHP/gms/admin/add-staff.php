...
$ret="select Email from tblstaff where Email=:email || MobileNumber=:mobnum || StaffID=:driid";
...
$sql="insert into tblstaff(StaffID,Name,MobileNumber,Email,Address,Password)values(:driid,:name,:mobnum,:email,:address,:password)";
...
<html lang="en">
<head>
<title>Garbage Management System: Add Staff</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Add Staff</a>
