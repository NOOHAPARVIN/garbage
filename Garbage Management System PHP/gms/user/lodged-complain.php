...
if (strlen($_SESSION["uuid"] == 0)) {
    ...
    if (isset($_POST["submit"])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            move_uploaded_file(
                $_FILES["garbagephoto"]["tmp_name"],
                "images/" . $garbagephoto
            );
            $sql =
                "insert into tbllodgedcomplain(UserID,ComplainNumber,Area,Locality,Landmark,Address,Photo,Note,WasteType)values(:uid,:complainnum,:area,:locality,:landmark,:address,:garbagephoto,:note,:wasteType)";
            ...
            $query->bindParam(":wasteType", $wasteType, PDO::PARAM_STR);
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form method="post" novalidate enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Photo</label>
                                         <input type="file" class="form-control" id="garbagephoto" name="garbagephoto" value="" >
                                    </div>
                                    <div class="form-group">
                                        <label>Waste Type</label>
                                        <select class="form-control" id="wastetype" name="wastetype" required='true'>
